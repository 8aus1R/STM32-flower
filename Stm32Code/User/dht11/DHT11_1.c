...
u8 tempInt,tempDeci,humiInt,humiDeci;
/*  tempInt,tempDeci,humiInt,humiDeci;*/
...
void	Get_dht11() {
    ...
    tempInt=dht11Data.temp_int;
    tempDeci=dht11Data.temp_deci;
    humiInt=dht11Data.humi_int;
    humiDeci=dht11Data.humi_deci;

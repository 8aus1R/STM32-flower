...
//			OLED_ShowFNum(16*0,2*0,temperatureC,16);
			oled_ShowNum(16*0,2*0,(int)temperatureC,2,16);
		}
    /*湿度测试*/
		if(SHT2x_Calc_RH())
		{
//			OLED_ShowFNum(16*0,2*1,humidityRH,16);
				oled_ShowNum(16*0,2*1,(int)humidityRH,2,16);
//			printf("湿度：%f%%\r\n",humidityRH);
		}
